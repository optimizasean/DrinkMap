...
CREATE TABLE INGREDIENT_TYPE (
	...
	CATEGORY VARCHAR(20) NOT NULL UNIQUE,
		CONSTRAINT PK_INGREDIENT_TYPE_ID PRIMARY KEY(ID)
);
------------------------------------------------------------------------------------------------------------------------------------------
CREATE TABLE BRAND (
	ID INT NOT NULL UNIQUE IDENTITY(1,1),
...
CREATE TABLE GLASSWARE (
	...
	DESCRIPTION TEXT,
		CONSTRAINT PK_GLASSWARE_ID PRIMARY KEY(ID)
);
------------------------------------------------------------------------------------------------------------------------------------------
...
CREATE TABLE INGREDIENT_MIX (
	...
	UNIT VARCHAR(25) DEFAULT(NULL),
		CONSTRAINT PK_INGREDIENT_MIX_ID PRIMARY KEY(ID),
...
CREATE TABLE GARNISH (
	ID INT NOT NULL UNIQUE IDENTITY(1,1),
	NAME VARCHAR(30) UNIQUE,
		CONSTRAINT PK_GARNISH_ID PRIMARY KEY(ID)
);
------------------------------------------------------------------------------------------------------------------------------------------
CREATE TABLE GARNISH_MIX (
	...
	MIXED_DRINK_ID INT NOT NULL DEFAULT(0),
	MIXTURE TEXT,
		CONSTRAINT PK_GARNISH_MIX_ID PRIMARY KEY(ID),
		CONSTRAINT FK_GARNISH_MIX_GARNISH_ID FOREIGN KEY(GARNISH_ID) REFERENCES GARNISH(ID),
...
CREATE TABLE REVIEW_DRINK (
	...
	MIXED_DRINK_ID INT NOT NULL DEFAULT(0),
		CONSTRAINT PK_REVIEW_DRINK_ID PRIMARY KEY(ID),
...
CREATE TABLE REVIEW_LOCATION (
	...
	LOCATION_ID INT NOT NULL DEFAULT(0),
		CONSTRAINT PK_REVIEW_LOCATION_ID PRIMARY KEY(ID),
